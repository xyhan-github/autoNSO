...
optAlg1 = LBFGS(objective, x0=x0, max_iter=iters, hist=iters, lr=0.1, linesearch=True,
                ls_params={'c1':1e-16, 'c2':1e3, 'max_ls':1e5}, tolerance_change=1e-16, tolerance_grad=1e-16) #, switch_crit=crit)
optAlg1.optimize()
alg_list += [optAlg1]
