...
from obj.obj_funcs import stronglyconvex, nonconvex, halfandhalf, PartlySmooth2D, PartlySmooth3D, Convex3D
...
# The max-eigenvalue (partly-smooth) example from Lewis-Wylie 2019 is still in development, so it's not included.
